    ...
    <div class="panel panel-default">
        ...
        >
            ...
            <h4 class="panel-title">
                ...
                <span class="pull-right" v-bind:style="headerCss" :background="color"></span>
            ...
            <div class="panel-body">
                ...
                <div class="color-picker">
                    ...
                    <div class="row colors">
                        ...
                        <div v-for="row in this.chunkColors" class="color-group">
        ...
        computed: {
            ...
            headerCss() {
                return {
                    width: '20px',
                    height: '20px',
                    backgroundColor: this.newColor ? this.newColor : this.color
                }
            }
        },
